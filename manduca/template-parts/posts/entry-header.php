...
<div class="columns-mask">
	<div class="columns-wrapper">
		...
		<div class="column-left">
				...
				$date_mask	='<p class="content-date"><time class="entry-date inverse1" datetime="%1$s"><span class="entry-date-month">%4$s</span> <span class="entry-date-day">%3$s</span> <span class="entry-date-year">%2$s</span></time></p>';
				...
				if ( strpos ( get_bloginfo( 'language' ), 'hu' ) !== FALSE ) {
						...
						$day 		.= '.';
						$date_mask	='<p class="content-date inverse1"><time class="entry-date " datetime="%1$s"><span class="entry-date-year">%2$s.</span> <span class="entry-date-month">%4$s</span> <span class="entry-date-day">%3$s</span></time></p>';
