...
jQuery(document).ready(function($) {
    ...
    $body.on('click keydown', '.js-expandmore-all', function(event) {
        var $this = $(this),
            ...
            txt_expand_all = typeof options.textExpandAll !== 'undefined' ? options.textExpandAll : manducaScreenReaderText.expand_all,
            txt_collapse_all = typeof options.textCloseAll !== 'undefined' ? options.textCloseAll : manducaScreenReaderText.collapse_all,
